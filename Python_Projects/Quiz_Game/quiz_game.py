...
def intro_message():
    ...
    """
    print("Welcome to this Avengers quiz! \nAre you ready to test your knowledge about Avangers?")
    print("There are a total of", len(quiz), "questions, you can skip a question anytime by typing 'skip'")
