...
class Main(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        # Create title label
        self.title_label = tk.Label(self, text='Currency Converter', bg='gray', fg='white', font=('franklin gothic medium', 20), relief='sunken')
        self.title_label.place(x=200, y=35, anchor='center')

        # Create date label
        self.date_label = tk.Label(self, text=f'{dt.datetime.now():%A, %B %d, %Y}', bg='gray', fg='white', font=('calibri', 10))
        self.date_label.place(x=0, y=400, anchor='sw')

        # Create version label
        self.version_label = tk.Label(self, text='v1.0', bg='gray', fg='white', font=('calibri', 10))
        self.version_label.place(x=400, y=400, anchor='se')

        # Create amount label
        self.amount_label =tk.Label(self, text='Input Amount: ', bg='gray', fg='white', font=('franklin gothic book', 15))
        ...
        # Create 'from' label
        self.base_currency_label = tk.Label(self, text='From: ', bg='gray', fg='white', font=('franklin gothic book', 15))
        self.base_currency_label.place(x=200, y=140, anchor='center')

        # Create 'to' label
        self.destination_currency_label = tk.Label(self, text='To: ', bg='gray', fg='white', font=('franklin gothic book', 15))
        self.destination_currency_label.place(x=200, y=200, anchor='center')

        # Create dropdown menus
        self.currency_variable1 = tk.StringVar(self)
        self.currency_variable2 = tk.StringVar(self)
        ...
        self.convert_button = tk.Button(self, text='Convert', bg='#52595D', fg='white', command=self.processed)
        self.convert_button.place(x=170, y=270, anchor='center')

        # Create 'clear' button
        self.clear_button = tk.Button(self, text='Clear', bg='red', fg='white', command=self.clear)
        self.clear_button.place(x=230, y=270, anchor='center')

        # Create converted result field
        self.final_result = tk.Label(self, text='', bg='gray', fg='white', font=('calibri', 12), relief='sunken', width=40)
        self.final_result.place(x=200, y=310, anchor='center')

    # Create clear function, to clear the amount field and final result field
    def clear(self):
        clear_entry = self.amount_entry.delete(0, tk.END)
    ...
    def processed(self):
        ...
        # Create warning message box
            ...
            convert_error = tk.messagebox.showwarning('WARNING!', 'Please Fill the Amount Field (integer only)!')
